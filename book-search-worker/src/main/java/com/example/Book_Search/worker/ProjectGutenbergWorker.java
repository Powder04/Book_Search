...
import com.example.Book_Search.openresource.ProjectGutenberg;
import lombok.extern.slf4j.Slf4j;

@Component
@Slf4j
public class ProjectGutenbergWorker extends BaseWorker {
    private final ProjectGutenberg resource;

    public ProjectGutenbergWorker(RabbitTemplate rabbitTemplate, RabbitMQProperties properties, ProjectGutenberg resource) {
